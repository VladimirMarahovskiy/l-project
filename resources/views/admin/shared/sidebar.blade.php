<ul class="navbar-nav navbar-sidenav">
    <li class="nav-item" role="presentation" data-toggle="tooltip" data-placement="right" title="@lang('dashboard.dashboard')">
        <a class="nav-link {{ request()->route()->named('dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}">
    ...
    <li class="nav-item" role="presentation" data-toggle="tooltip" data-placement="right" title="@lang('dashboard.category')">
        <a class="nav-link {{ request()->route()->named('admin.category.*') ? 'active' : '' }}" href="{{ route('admin.category.index') }}">
    ...
    <li class="nav-item" role="presentation" data-toggle="tooltip" data-placement="right" title="@lang('dashboard.reports')">
        <a class="nav-link {{ request()->route()->named('admin.report.*') ? 'active' : '' }}" href="{{ route('admin.report.index') }}">
            <i class="fa fa-users" aria-hidden="true"></i>&nbsp;
            <span class="nav-link-text">@lang('dashboard.reports')</span>
        </a>
    </li>
